      ...
      <div className="">
        <div
          className={` absolute left-0 w-full bg-white z-20  ${
            openSearchBar ? "top-0" : "top-[-9000%]  "
          } `}
        >
          <div className="p-10 sm:px-20 lg:px-52">
            <div className="rounded-full overflow-hidden border-2 border-neutral-400 flex bg-slate-400 ">
              <input
                type="text"
            ...
            <AiOutlineClose
              className=" absolute right-5 md:right-10 top-14 text-4xl border-neutral-200 transition-all duration-500 hover:rotate-180 hover:text-gray-600 cursor-pointer hidden sm:block"

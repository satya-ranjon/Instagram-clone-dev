  ...
  return (
    <div className="relative mx-72">
      <div
        ...
        } absolute bg-[#ebe6e670] z-10 w-10 cursor-pointer left-0 bottom-0 rounded-xl h-full`}
        onClick={() => scrollOnClick("left")}
      >
        <BiChevronLeft className="my-4 text-gray-900 text-3xl" />
      </div>
      <div
        ref={scrollRef}
        className=" flex space-x-9 overflow-hidden  scroll-smooth overflow-x-scroll hide_scrollbar relative "
      >
        <div className="">
          ...
          <p className="text-sm text-center font-semibold text-gray-400 text-gray-500">
            Your Story
          </p>
        </div>
      ...
      <div
        className=" absolute bg-[#ebe6e670] w-10 cursor-pointer right-0 bottom-0 rounded-xl h-full"
        onClick={() => scrollOnClick("right")}
      >
        <BiChevronRight className="my-4 text-gray-900 text-3xl" />
      </div>
    </div>
  );
}

...
export default function StoreBar() {
  ...
  return (
    <div
      className="flex mx-72 overflow-y-hidden items-center w-full h-10 overflow-y-scroll overFlowHiden hide_scrollbar relative"
      id="category"
    >
      <div
        className={` ${
      ...
      <div ref={scrollRef} className="flex justify-between space-x-10">

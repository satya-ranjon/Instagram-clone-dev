      ...
      <div className="">
        ...
        >
          <div className="p-10 sm:px-20 lg:px-52">
            ...
            <AiOutlineClose className=" absolute right-10 top-14 text-4xl text-gray-400 transition-all duration-500 hover:rotate-180 hover:text-gray-600 cursor-pointer hidden sm:visible " />
          </div>
        </div>
        <div

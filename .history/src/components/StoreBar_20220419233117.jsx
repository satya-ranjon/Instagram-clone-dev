...
export default function StoreBar() {
  ...
  return (
    <div
      className="flex items-center w-full h-10 overflow-y-scroll mx-52 overFlowHiden hide_scrollbar relative"
      id="category"
    >
      <div
        className={` ${
      ...
      <div
        ref={scrollRef}
        className="flex space-x-10 items-center w-full overflow-y-scroll hide_scrollbar scroll-smooth duration-150 ease-in-out"
      >

        ...
        <div className="flex w-full my-5 justify-end">
          <div className="flex space-x-2 flex-row-reverse">
            ...
            <div className="flex flex-row-reverse">
              <div className="w-5 h-5 bg-neutral-500 rounded-tl-[50%] ">
                <div className="w-full h-full bg-neutral-50 rounded-tl-[100%]"></div>
              </div>
              <p className="bg-neutral-500 p-4 w-fit max-w-sm text-white relative rounded-3xl rounded-tr-none ">
                hello Lorem ipsum dolor sit amet consectetur adipisicing elit.
                😀
              </p>
            </div>

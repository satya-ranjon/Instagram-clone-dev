...
export default function InboxHader() {
  return (
    <div className=" fixed top-0 h-20 bg-white w-full z-10 flex">
      <div className="w-96 h-full justify-center flex space-x-8 text-neutral-600 font-semibold transition-all duration-300">
      ...
      <div className="w-full h-full bg-[#f4f7ff] border-l-2">
        <MesseagBoxHader />
      </div>
    </div>
  );

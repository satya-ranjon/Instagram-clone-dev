      ...
      <div className="transition-all duration-300">
        ...
        >
          <div className="p-10 sm:px-20 lg:px-52">
            <div className="rounded-full overflow-hidden border-2 border-neutral-400 flex bg-neutral-400 transition-all duration-300 ">
              <input
                type="text"
        ...
        <div
          onClick={() => setOpenSideBar((prv) => !prv)}
          className={` transition-all duration-300 h-screen w-full bg-[#3634344b] fixed left-0 ${

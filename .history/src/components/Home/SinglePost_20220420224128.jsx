...
export default function PostList({ imgdesign }) {
  return (
    <div className=" my-4">
      <img
        className={imgdesign}
        src="https://img.freepik.com/free-photo/food-delivery-man-with-boxes-with-food_1303-27723.jpg?t=st=1650472863~exp=1650473463~hmac=2ae6168d6c59c795711a473528e6d3c213053acf1045b21011ab096dec031314&w=1380"
        alt=""
      />

...
export default function PostList({ imgdesign }) {
  return (
    <div className=" my-4">
      <img
        className={imgdesign}
        src="https://img.freepik.com/free-photo/young-couple-dances-social-caribbean-salsa_155003-7839.jpg?t=st=1650472863~exp=1650473463~hmac=87115705c0fa86acc333f8e538550b63c944fd3fc863aca2d49cfe0105bf2822&w=1380"
        alt=""
      />
      ...
      <div className="p-3 flex justify-between ">
        <div className="flex space-x-4">
          ...
          <div
            className={`
              ${
                (imgdesign === "img__two" && `sm:hidden md:block`) ||

...
export default function StoreBar() {
  ...
  return (
    <div
      div
      className="mx-72 flex space-x-9 overflow-hidden h-32 overflow-x-scroll "
    >
      <div className=" border-2 cursor-pointer overflow-hidden hide_scrollbar rounded-full relative p-1 my-auto border-gray-400 ">
        <Avatar
          alt="Travis Howard"

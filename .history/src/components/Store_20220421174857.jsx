...
export default function Store() {
  return (
    <div className="">
      <div className=" bground bg-[radial-gradient(ellipse at 70% 70%, #ee583f 8%, #d92d77 42%, #bd3381 58%)] border-2 cursor-pointer rounded-full p-1 my-auto border-[rgb(176,81,81)] ">
        <Avatar

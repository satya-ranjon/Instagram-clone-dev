...
export default function StoryPage() {
  const activeDesign =
    "border-2 fixed top-0 translate-y-[10%]  overflow-hidden rounded-md p-2 w-[400px] h-[780px]";
  const leftSideDesign =
    "border-2 overflow-hidden rounded-md p-2 w-[300px] h-[480px]  absolute left-[20%] top-20";
  const RightSideDesign =
    "border-2 overflow-hidden rounded-md p-2 w-[300px] h-[480px]  absolute right-[20%] top-20";
  return (
      ...
      <div className="fixed w-full h-[600px] bg-[#ff00001c] top-[20%] ">
        <div className="flex justify-center">
          ...
          <div className={leftSideDesign}>
            <div className=" absolute left-1 right-1 translate-y-[1rem] ">
              <img
                className=" h-full"
                src="https://images.pexels.com/photos/11185227/pexels-photo-11185227.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
                alt=""
              />
            </div>
          </div>

    ...
    <div className="bg-[#1a1a1a] h-screen w-full ">
      ...
      <div className="fixed w-full h-[600px] bg-[#ff00001c] top-[20%] ">
        <div className="flex justify-center">
          ...
          <div className="border-2 fixed top-0 left-0  overflow-hidden rounded-md p-2 w-[300px] h-[480px] translate-x-[25rem] translate-y-60">
            <div className="">
              <img
                className=" h-full"
                src="https://images.pexels.com/photos/11161043/pexels-photo-11161043.jpeg?cs=srgb&dl=pexels-merve-%C5%9Fahin-11161043.jpg&fm=jpg"
          ...
          <div className="border-2 fixed top-0 right-0  overflow-hidden rounded-md p-2 w-[300px] h-[480px] -translate-x-[25rem] translate-y-60">
            <div className="">
              <img
                className=" h-full"

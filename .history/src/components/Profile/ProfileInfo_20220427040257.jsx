...
export default function ProfileInfo() {
  ...
  return (
    <>
      <div className="rounded-full overflow-hidden relative profile_img cursor-pointer">
        <Avatar
          alt={currentUser.displayName}
          src={currentUser.photoURL}
          sx={{ width: 96, height: 96 }}
        />
        <div className=" absolute top-0 left-0  h-full w-full bg-[#0000006c] z-10 flex justify-center cursor-pointer hover__profile transition-all duration-300">

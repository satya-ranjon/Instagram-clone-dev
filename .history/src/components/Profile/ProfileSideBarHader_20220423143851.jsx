...
export default function ProfileSideBarHader() {
  ...
  return (
    <div className="flex justify-between px-3 p-2 text-neutral-500 relative">
      ...
      <div
        className={`absolute right-10 bg-neutral-600 text-neutral-100 font-semibold text-md transition-all duration-300 ${
      ...
      >
        ...
        <Link className="py-1 cursor-pointer hover:bg-neutral-500 px-5 transition-all duration-300">
          Logout
        </Link>
      </div>
    </div>

...
export default function ProfileImgUpLoad({ upimgOpen, setUpimgOpen }) {
  ...
  return (
    <div>
      ...
      >
        <div className="sm:w-[36rem] transition-all duration-300 lg:w-[50rem] sm:h-[30rem] lg:h-[40rem]  cursor-pointer ">
          <form
            className={`absolute w-full cursor-pointer sm:h-[27rem] lg:h-[36rem]  ${
              !preview && "bg__img"
            } `}
          >
            <input

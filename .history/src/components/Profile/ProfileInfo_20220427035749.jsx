  ...
  return (
    <>
      <div className="rounded-full overflow-hidden relative">
        ...
        />
        <div className=" absolute top-0 left-0  h-full w-full bg-[#0000003a] z-10 flex justify-center cursor-pointer">
          <AiOutlineCloudUpload className="z-10 text-red-400 text-2xl my-auto" />
        </div>
      </div>

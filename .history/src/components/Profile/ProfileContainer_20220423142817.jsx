    ...
    <div className="flex ">
      <div className="w-[40rem] h-screen bg-slate-50">
        <div className="flex justify-between px-3 p-2 text-neutral-500 relative">
          ...
          <div className=" absolute right-10 bg-neutral-600 text-neutral-100 px-5 font-semibold text-md">
            <p className="py-1 cursor-pointer hover:bg-neutral-400">Setting</p>
            <p className="py-1 cursor-pointer hover:bg-neutral-400">Logout</p>
          </div>
        </div>
      </div>

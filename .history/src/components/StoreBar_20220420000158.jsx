...
export default function StoreBar() {
  ...
  return (
    <div className="relative mx-72">
      <div
        className=" absolute bg-[#ebe6e670] z-10 w-10 cursor-pointer left-0 bottom-0 rounded-xl h-full"
      ...
      <div
        ref={scrollRef}
        className=" flex space-x-9 overflow-hidden h-16 scroll-smooth overflow-x-scroll hide_scrollbar relative "
      >

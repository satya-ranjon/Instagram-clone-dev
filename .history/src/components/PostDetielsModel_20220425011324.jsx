  ...
  return (
    <>
      <div className="">
        ...
        >
          <div className="w-full transition-all duration-300 sm:w-[36rem]   lg:w-[60rem] xl:w-[75rem] h-[70rem] sm:h-[30rem] lg:h-[50rem] flex md:flex-row flex-col justify-between">
